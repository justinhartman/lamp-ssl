[![Waffle.io - Columns and their card count](https://badge.waffle.io/justinhartman/Automated-LAMP-with-trusted-localhost-SSL.png?columns=all)](https://waffle.io/justinhartman/Automated-LAMP-with-trusted-localhost-SSL?utm_source=badge) [![pipeline status](https://gitlab.com/justinhartman/Automated-LAMP-with-trusted-localhost-SSL/badges/master/pipeline.svg)](https://gitlab.com/justinhartman/Automated-LAMP-with-trusted-localhost-SSL/commits/master) [![Build Status](https://travis-ci.org/justinhartman/Automated-LAMP-with-trusted-localhost-SSL.svg?branch=master)](https://travis-ci.org/justinhartman/Automated-LAMP-with-trusted-localhost-SSL) [![coverage report](https://gitlab.com/justinhartman/Automated-LAMP-with-trusted-localhost-SSL/badges/master/coverage.svg)](https://gitlab.com/justinhartman/Automated-LAMP-with-trusted-localhost-SSL/commits/master)
